...
public class TabHostActivity extends TabActivity   {
	...
	private void setupIntent() {
		...
		//localTabHost.addTab(buildTabSpec(TAB_TAG_WORK, R.string.study,R.drawable.ic_launcher, workIntent));
		//localTabHost.addTab(buildTabSpec(TAB_TAG_MESSAGE, R.string.message,R.drawable.ic_launcher, messageIntent));
		localTabHost.addTab(buildTabSpec(TAB_TAG_COMMUNICATION,
				R.string.curriculum, R.drawable.ic_launcher,
				communicationIntent));
		//localTabHost.addTab(buildTabSpec(TAB_TAG_ALBUM,R.string.album, R.drawable.ic_launcher,albumIntent));
